...
if args.cal_metrics:
    ...
    print(f'## {args.ex_name}')
    print("\nPSNR: %f, SSIM: %f, RMSE: %f " %(psnr_val_rgb, ssim_val_rgb, rmse_val_rgb))
    print("\nSPSNR: %f, SSSIM: %f, SRMSE: %f " %(psnr_val_s, ssim_val_s, rmse_val_s))
    print("\nNSPSNR: %f, NSSSIM: %f, NSRMSE: %f " %(psnr_val_ns, ssim_val_ns, rmse_val_ns))
    print(f'\n|{args.ex_name}|{psnr_val_rgb:.6f}|{rmse_val_rgb:.6f}|{psnr_val_s:.6f}|{rmse_val_s:.6f}|{psnr_val_ns:.6f}|{rmse_val_ns:.6f}|')
